...
test("Deve tentar validar o token inválido", async function () {
  const token =
    "eyJhbGciOiJIU5cCI6IkpXVCJ9.eyJlbWFpbCI6ImpvYW9AZ21haWwuY29tIiwiaWF0IjoxNjc3Njc1NjAwMDAwLCJleHBpcmVzSW4iOjEwMDAwMDB9.nPHGoaoMLLpmDS61-njfqX6G5ZvwT3Y5U71uOXGbRYY";
  const tokenGenerator = new TokenGenerator("key");
